...
class QuicClientMessageLoop
    : public QuicClient::NetworkHelper,
      public QuicChromiumPacketReader::Visitor {
 public:
  // Create a quic client, which will have events managed by an externally owned
  // EpollServer.
  QuicClientMessageLoop(QuicChromiumClock* clock,
                                      QuicClient* client);

  ~QuicClientMessageLoop() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(QuicClientMessageLoop);
};
